...
module tb;
  ...
  initial begin
    ...
    t_s = 1'b0; t_i1 = 1'b0; t_i0 = 1'b0; #5; // 000
    t_s = 1'b0; t_i1 = 1'b0; t_i0 = 1'b1; #5; // 001
    t_s = 1'b0; t_i1 = 1'b1; t_i0 = 1'b0; #5; // 010
    t_s = 1'b0; t_i1 = 1'b1; t_i0 = 1'b1; #5; // 011
    t_s = 1'b1; t_i1 = 1'b0; t_i0 = 1'b0; #5; // 100
    t_s = 1'b1; t_i1 = 1'b0; t_i0 = 1'b1; #5; // 101
    t_s = 1'b1; t_i1 = 1'b1; t_i0 = 1'b0; #5; // 110
    t_s = 1'b1; t_i1 = 1'b1; t_i0 = 1'b1; #5; // 111
